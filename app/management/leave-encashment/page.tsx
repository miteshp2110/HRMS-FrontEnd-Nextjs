...
//                         <TabsTrigger value="approval">Manager Approval Queue</TabsTrigger>
//                         <TabsTrigger value="disbursement">Finance Disbursement Queue</TabsTrigger>
//                     </TabsList>
//                     <TabsContent value="approval">
//                         <Card>
//                             <CardHeader><CardTitle>Pending Manager Approval</CardTitle></CardHeader>
//                             <CardContent>
//                                 <Table>
//                                     <TableHeader>
//                                         <TableRow>
//                                             <TableHead>Employee</TableHead><TableHead>Days</TableHead><TableHead>Amount</TableHead><TableHead className="text-right">Action</TableHead>
//                                         </TableRow>
//                                     </TableHeader>
//                                      <TableBody>
...
//                          <Card>
//                             <CardHeader><CardTitle>Pending Disbursement</CardTitle></CardHeader>
//                             <CardContent>
//                                 <Table>
//                                      <TableHeader>
//                                         <TableRow>
...
//                                                 <TableCell>${Number(req.calculated_amount).toLocaleString()}</TableCell>
//                                                 <TableCell className="text-right">
//                                                     <Button size="sm" variant="outline" onClick={() => {setSelectedRequest(req); setIsDisburseDialogOpen(true);}}>Disburse</Button>
//                                                 </TableCell>
//                                             </TableRow>
//                                         ))}
//                                      </TableBody>
