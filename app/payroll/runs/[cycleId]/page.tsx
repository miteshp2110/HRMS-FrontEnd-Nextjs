...
//     const markAsPaid = async (jv:string) => {
//         if (!cycle) return;
        
//         setIsMarkingPaid(true);
//         try {
//             await markCycleAsPaid(Number(cycleId),jv)
//             toast({ 
//                 title: "Success", 
                    ...
                    {cycle.status === 'Finalized' && (
                        <Dialog open={isDialogOpen} onOpenChange={(open) => {
                            ...
                            <DialogContent className="sm:max-w-md">
                                <DialogHeader>
                                    <DialogTitle>Mark Payroll Cycle as Paid</DialogTitle>
                                    <DialogDescription>
                                        Please enter the Journal Voucher (JV) number to confirm this action.
                                    </DialogDescription>
                                </DialogHeader>
                                <div className="grid gap-4 py-4">
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        <Label htmlFor="jv-number" className="text-right">JV Number</Label>
                                        <Input
                                            id="jv-number"
                                            value={jvNumber}
                                ...
                                <DialogFooter>
                                    ...
                                    <Button 
                                        ...
                                        disabled={isMarkingPaid || !jvNumber.trim()}
                                    >
                                        {isMarkingPaid && <Loader2 className="w-4 h-4 animate-spin mr-2" />}
