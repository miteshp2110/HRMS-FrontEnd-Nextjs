    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">{new Date(payrollRun.from_date).toLocaleDateString()} to {new Date(payrollRun.to_date).toLocaleDateString()}</p>
        </div>
      </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                {selectedPayslip && payrollRun.status === "draft" && <Button size="sm" onClick={handleCreate}><Plus className="h-4 w-4 mr-2" />Add Component</Button>}
              </div>
            </CardHeader>
            <CardContent>
              {selectedPayslip ? (
                <div className="space-y-4">
                  <Table>
                    <TableHeader><TableRow><TableHead>Component</TableHead><TableHead>Type</TableHead><TableHead className="text-right">Amount</TableHead>{payrollRun.status === "draft" && <TableHead className="text-right">Actions</TableHead>}</TableRow></TableHeader>
                    <TableBody>
