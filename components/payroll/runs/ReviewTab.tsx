...
//             <InfoRow label="Computed Value" value={formatCurrency(breakdown.calculated_value)} />
//         </CardContent>
//     </Card>
// );
...
const CalculationBreakdownDialog = ({ open, onOpenChange, detail,componentMap }: BreakdownDialogProps) => {
    ...
    const renderContent = async() => {
        ...
        // Manual Adjustment
        if (breakdown.source === "Manual Adjustment" || breakdown.component_type === "manual") {
...
const ManualAdjustmentBreakdown = ({ breakdown }: { breakdown: any }) => (
    <Card className="border-border/40 dark:border-border/20 bg-gradient-to-br from-purple-50/50 to-card dark:from-purple-900/10 dark:to-card/50">
        ...
        <CardContent className="space-y-1">
            ...
            <InfoRow 
                label="Adjusted By" 
                value={`User ID: ${breakdown.adjusted_by}`} 
        ...
        {breakdown.shift_details && (
            <Card className="border-border/40 dark:border-border/20 bg-card dark:bg-card/50">
                ...
                <CardContent className="space-y-1">
                    ...
                    <InfoRow 
                        label="From Time" 
                        value={breakdown.shift_details.from_time} 
                    />
                    <InfoRow 
                        label="To Time" 
                        value={breakdown.shift_details.to_time} 
                    />
                </CardContent>
            </Card>
        )}
...
// const FormulaBreakdown = ({ breakdown }: { breakdown: any }) => (
//     <div className="space-y-4">
//         <Card className="border-border/40 dark:border-border/20 bg-card dark:bg-card/50">
//             <CardHeader className="flex-row items-center space-x-3 pb-3">
//                 <div className="p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg">
...
//                 </div>
//                 <div>
//                     <h4 className="font-semibold dark:text-foreground/90">Custom Formula Calculation</h4>
//                     <p className="text-xs text-muted-foreground dark:text-muted-foreground/70">
//                         Calculated using custom formula
//                     </p>
//                 </div>
//             </CardHeader>
//             <CardContent className="space-y-1">
...
//                     <InfoRow 
//                         label="Raw Formula" 
//                         value={JSON.stringify(breakdown.raw_formula_array)} 
//                         isCode 
//                     />
//                 )}
//                 {breakdown.parsed_expression && (
//                     <InfoRow 
//                         label="Expression" 
//                         value={breakdown.parsed_expression} 
//                         isCode 
//                     />
//                 )}
//                 {breakdown.component_values_used && Object.keys(breakdown.component_values_used).length > 0 && (
//                     <div className="pt-2">
//                         <p className="text-sm font-medium text-muted-foreground dark:text-muted-foreground/80 mb-2">
//                             Component Values Used:
//                         </p>
...
//                         value={breakdown.calculation_steps} 
//                         isCode 
//                     />
//                 )}
//                 <InfoRow 
//                     label="Result" 
//                     value={formatCurrency(breakdown.result || 0)} 
//                     icon={<DollarSign className="w-4 h-4" />}
//                 />
//             </CardContent>
//         </Card>
