...
//     title: "Payroll",
//     icon: CreditCard,
//     permission: "payroll.manage", // This group requires a single permission to show
//     children: [
//       {
...
//   // --- Start of Fix ---
//   // Simplified, purely permission-based visibility logic
//   const shouldShowItem = (item: NavItem): boolean => {
//     // If the item has children (it's a group), it's visible if any of its children are visible.
//     if (item.children) {
//       return item.children.some(child => shouldShowItem(child));
//     }
    
//     // If it's a direct link, it's visible if it has no permission requirement,
//     // OR if the user has the specific permission.
...
import {
  ...
  Banknote,
  Wallet,
  CalendarPlus, // Import the correct icon if it's missing
} from "lucide-react"
