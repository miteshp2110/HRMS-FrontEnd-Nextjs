...
//         <CardDescription>
//           A quick overview of your attendance this month.
//         </CardDescription>
//       </CardHeader>
//       <CardContent>
...
//             <strong>{monthlyAttendance.total_hours_worked} hrs</strong>
//           </div>
//           <div className="flex justify-between">
//             <span>Approved OT:</span>
//             <strong>{monthlyAttendance.approved_overtime} hrs</strong>
//           </div>
//           <div className="flex justify-between">
//             <span>Rejected OT:</span>
//             <strong>{monthlyAttendance.rejected_overtime} hrs</strong>
//           </div>
//         </div>
//       </CardContent>
//     </Card>
