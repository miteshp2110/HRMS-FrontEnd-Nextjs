...
//         toast({
//           title: "Error",
//           description: `Failed to load calendar data: ${error.message}`,
//           variant: "destructive",
//         });
//       } finally {
//         setIsLoading(false);
...
//       toast({
//         title: "Error",
//         description: `Failed to create holiday: ${error.message}`,
//         variant: "destructive",
//       });
//     }
//   };
...
//     setWorkWeek((current) =>
//       current.map((d) =>
//         d.day_of_week === day ? { ...d, is_working_day: checked } : d
//       )
//     );
//   };
...
//       holidays.map((h) => h.holiday_date.split("T")[0])
//     );
//     const nonWorkingWeekDays = new Set(
//       workWeek.filter((d) => !d.is_working_day).map((d) => d.day_of_week)
//     );
...
//         <AlertDescription>
//           You don't have permission to manage the company calendar.
//         </AlertDescription>
//       </Alert>
//     );
//   }
...
//                 <DialogDescription>
//                   Add a new company holiday for the year {year}.
//                 </DialogDescription>
//               </DialogHeader>
