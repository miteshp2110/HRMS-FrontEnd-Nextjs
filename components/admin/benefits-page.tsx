...
//                         <div className="grid gap-2"><Label>Min Years of Service</Label><Input  value={formData.min_years_service} onChange={e => setFormData({...formData, min_years_service: Number(e.target.value)})} /></div>
//                         <div className="grid gap-2"><Label>Max Years of Service</Label><Input  value={formData.max_years_service} onChange={e => setFormData({...formData, max_years_service: Number(e.target.value)})} /></div>
...
//                         <div className="grid gap-2"><Label>Leave Salary Percentage</Label><Input  value={formData.leave_salary_percentage} onChange={e => setFormData({...formData, leave_salary_percentage: Number(e.target.value)})} /></div>
//                         <div className="grid gap-2"><Label>LTA Amount ($)</Label><Input  value={formData.lta_allowance} onChange={e => setFormData({...formData, lta_allowance: Number(e.target.value)})} /></div>
//                         <div className="grid gap-2"><Label>LTA Frequency (Years)</Label><Input  value={formData.lta_frequency_years} onChange={e => setFormData({...formData, lta_frequency_years: Number(e.target.value)})} /></div>
//                         <div className="grid gap-2"><Label>Additional Annual Leaves</Label><Input  value={formData.additional_annual_leaves} onChange={e => setFormData({...formData, additional_annual_leaves: Number(e.target.value)})} /></div>
//                         <div className="grid gap-2"><Label>Education Allowance (per child)</Label><Input  value={formData.education_allowance_per_child} onChange={e => setFormData({...formData, education_allowance_per_child: Number(e.target.value)})} /></div>
//                         <div className="grid gap-2"><Label>Fuel Allowance (monthly)</Label><Input  value={formData.fuel_allowance_monthly} onChange={e => setFormData({...formData, fuel_allowance_monthly: Number(e.target.value)})} /></div>
