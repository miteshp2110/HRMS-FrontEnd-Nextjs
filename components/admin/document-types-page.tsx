...
//     try {
//       await updateDocumentType(selectedDocType.id, { name })
...
//         <AlertDescription>
//           You don't have permission to manage document types.
//         </AlertDescription>
//       </Alert>
//     )
//   }
        ...
        <DialogContent>
          ...
          <form onSubmit={handleEdit}>
            <div className="space-y-4 py-4">
              ...
              <div>
                <Label htmlFor="edit-reminder_threshold">Reminder Threshold (Days)</Label>
                <Input id="edit-reminder_threshold" name="reminder_threshold" type="number" defaultValue={selectedDocType?.reminder_threshold} required />
              </div>
            </div>
            <DialogFooter>
              <Button type="button" variant="outline" onClick={() => setEditDialogOpen(false)}>Cancel</Button>
