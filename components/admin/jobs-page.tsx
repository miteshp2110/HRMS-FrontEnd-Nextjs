    ...
    return (
      <div className="space-y-6">
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            You don't have permission to manage job titles. Contact your administrator for access.
          </AlertDescription>
        </Alert>
      </div>
    )
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage available job titles in the organization</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
