...
// export function PersonalDetailsTab({ profile, isEditing, onSave, onCancel }: PersonalDetailsTabProps) {
...
//     // Only pass the changed fields to the save function
...
//               {isEditing ? (
//                 <Input id="dob" name="dob" type="date" value={formatDateForInput(formData.dob)} onChange={handleChange} />
//               ) : (
