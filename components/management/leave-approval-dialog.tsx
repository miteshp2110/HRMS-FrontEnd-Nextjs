...
interface LeaveApprovalDialogProps {
  ...
  onStatusUpdate: (leaveId: number, status: boolean, reason?: string) => void
}
...
export function LeaveApprovalDialog({ leaveRecord, open, onOpenChange, onStatusUpdate }: LeaveApprovalDialogProps) {
  ...
  const handleConfirmRejection = () => {
      ...
      onStatusUpdate(leaveRecord.id, false, rejectionReason);
                              ...
                              <div className="flex items-center space-x-4">
                                  ...
                                  <div>
                                      <CardTitle className="text-xl">
                                          <Link href={`/directory/${leaveRecord.employee_id}`} target="_blank" rel="noopener noreferrer" className="hover:underline cursor-pointer">
      ...
      <AlertDialog open={isRejectDialogOpen} onOpenChange={setIsRejectDialogOpen}>
          <AlertDialogContent>
              <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>Please provide a reason for this rejection. This will be visible to the employee.</AlertDialogDescription>
              </AlertDialogHeader>
              <div className="py-2">
              ...
              <AlertDialogFooter>
                  ...
                  <AlertDialogAction onClick={handleConfirmRejection} disabled={!rejectionReason.trim()}>Confirm Rejection</AlertDialogAction>
              </AlertDialogFooter>
          </AlertDialogContent>
      </AlertDialog>
    </>
