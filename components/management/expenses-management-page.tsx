...
//                 <CardContent>
//                     <Table>
//                         <TableHeader><TableRow><TableHead>Employee</TableHead><TableHead>Title</TableHead><TableHead>Amount</TableHead><TableHead>Date</TableHead><TableHead className="text-right">Actions</TableHead></TableRow></TableHeader>
//                         <TableBody>
...
//                                         <Button variant="ghost" size="sm"><Eye className="h-4 w-4 mr-2"/>Review</Button>
//                                     </TableCell>
//                                 </TableRow>
//                             ))}
//                         </TableBody>
...
//                 <CardContent>
//                      <Table>
//                         <TableHeader><TableRow><TableHead>Employee</TableHead><TableHead>Title</TableHead><TableHead>Amount</TableHead><TableHead>Date</TableHead><TableHead>Status</TableHead></TableRow></TableHeader>
//                         <TableBody>
//                             {allClaims.map(claim => (
//                                 <TableRow key={claim.id} onClick={() => handleReviewClick(claim)} className="cursor-pointer">
//                                     <TableCell>{claim.employee_name}</TableCell>
