...
//         setShiftDetails(shift as Shift | undefined)
//       }
//     })
    
//   }
//   useEffect(()=>{
//     getShiftDetails(selectedShiftId)
//   },[selectedShiftId])
...
//                     <Input
//                       type="time"
//                       value={shiftDetails?convertUTCToTimeZone(shiftDetails?.from_time!,localStorage.getItem('selectedTimezone')??'UTC'):''}
//                       onChange={(e) =>
//                         setAttendanceData({ ...attendanceData, punch_in_local: e.target.value })
//                       }
...
//                     <Input
//                       type="time"
//                       value={shiftDetails?convertUTCToTimeZone(shiftDetails?.to_time!,localStorage.getItem('selectedTimezone')??'UTC'):''}
//                       onChange={(e) =>
//                         setAttendanceData({ ...attendanceData, punch_out_local: e.target.value })
//                       }
//                     />
//                   </div>
//                 </div>
...
//                       onCheckedChange={(c) =>
//                         setAttendanceData({ ...attendanceData, is_early_departure: c })
//                       }
//                     />
...
//                             </TableCell>
//                             <TableCell>
//                               {emp.first_name} {emp.last_name} ({emp.full_employee_id})
//                             </TableCell>
//                           </TableRow>
//                         ))}
//                       </TableBody>
...
export function BulkAttendanceDialog({
  ...
  useEffect(() => {
    if (shiftDetails) {
      ...
      const punchInTime = convertUTCToTimeZone(shiftDetails.from_time, timezone);
